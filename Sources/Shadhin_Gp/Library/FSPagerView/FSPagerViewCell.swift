...
import UIKit
 ...
 class FSPagerViewCell: UICollectionViewCell {
    ...
    fileprivate weak var _imageView: UIImageView?
     fileprivate weak var _mark : UIImageView?
...
//    }
    ...
    override  func layoutSubviews() {
        ...
        if let mark = _mark{
            mark.frame = .init(x: self.contentView.bounds.width  - 48, y: 8, width: 40, height: 20)
        }
        if let textLabel = _textLabel {
