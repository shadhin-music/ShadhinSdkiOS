...
public protocol ReconnectPolicy {
     ...
     */
    func nextAttemptInterval(retryContext: SRRetryContext) -> DispatchTimeInterval
}
...
public class DefaultReconnectPolicy: ReconnectPolicy {
    ...
    public func nextAttemptInterval(retryContext: SRRetryContext) -> DispatchTimeInterval {
