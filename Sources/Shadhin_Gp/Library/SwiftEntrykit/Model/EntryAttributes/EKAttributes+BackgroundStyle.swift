 ...
 extension EKAttributes {
    ...
    enum BackgroundStyle: Equatable {
        ...
        /** Blur style for light and dark modes */
         struct BlurStyle: Equatable {
            
             static var extra: BlurStyle {
                return BlurStyle(light: .extraLight, dark: .dark)
            }
            
             static var standard: BlurStyle {
                return BlurStyle(light: .light, dark: .dark)
            }
            
            @available(iOS 10.0, *)
             static var prominent: BlurStyle {
                return BlurStyle(light: .prominent, dark: .prominent)
            }
            
             static var dark: BlurStyle {
            ...
            let dark: UIBlurEffect.Style
             ...
             init(light: UIBlurEffect.Style, dark: UIBlurEffect.Style) {
                self.light = light
                self.dark = dark
            }
            
            /** Computes a proper `UIBlurEffect.Style` instance */
             func blurStyle(for traits: UITraitCollection,
             ...
             func blurEffect(for traits: UITraitCollection,
