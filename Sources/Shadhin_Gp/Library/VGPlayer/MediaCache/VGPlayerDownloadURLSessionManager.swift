...
import Foundation
 ...
 protocol VGPlayerDownloadeURLSessionManagerDelegate: NSObjectProtocol {
 ...
 class VGPlayerDownloadURLSessionManager: NSObject, URLSessionDataDelegate {
    ...
    fileprivate let bufferDataQueue = DispatchQueue(label: "com.vgplayer.bufferDataQueue")
     ...
     weak var delegate: VGPlayerDownloadeURLSessionManagerDelegate?
    
     init(delegate: VGPlayerDownloadeURLSessionManagerDelegate?) {
