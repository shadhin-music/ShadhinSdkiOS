...
internal class PBChevronView: UIView {
    ...
    func _commonInit() {
        self.tintColor = nil
        self.widthh = _PBChevronDefaultWidth
    ...
    override func layoutSubviews() {
        ...
        leftFrame.size.height = self.widthh
        ...
        leftFrame = leftFrame.offsetBy(dx: widthh / 2 + dx - 0.75, dy: 0.0)
        rightFrame = rightFrame.offsetBy(dx: -(widthh / 2) - dx + 0.75, dy: 0.0)
        ...
        self.leftView.layer.cornerRadius = widthh / 2.0
        self.rightView.layer.cornerRadius = widthh / 2.0
        self.setState(state, animated: false)
    }
