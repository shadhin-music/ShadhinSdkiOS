...
@objc public class PBPopupBar: UIView {
    ...
    @objc public var popupBarStyle: PBPopupBarStyle = .default {
        ...
        didSet {
            ...
            //let effect = self.backgroundStyle == nil ? nil : UIBlurEffect(style: self.backgroundStyle!)
     ...
     */
//    public var backgroundStyle: UIBlurEffect.Style? {
//        get {
//            #if compiler(>=5.1)
//            if #available(iOS 13.0, *) {
...
//            self.backgroundView.effect = newValue == nil ? nil : UIBlurEffect(style: newValue!)
...
//    }
    ...
    //@objc public private(set) var shadowStackView: PBPopupBarTitlesView!
    /**
    ...
    @objc public var title: String? {
        didSet {
            ...
            self.shadowStackView.titleLabel?.isHidden = title == nil
            self.configureTitleLabels()
    ...
    @objc public var subtitle: String? {
        didSet {
            ...
            self.shadowStackView.subtitleLabel?.isHidden = subtitle == nil
            self.configureTitleLabels()
            self.configureAccessibility()
        }
    }
    ...
    override public var accessibilityLabel: String? {
        get {
            return self.shadowStackView.accessibilityLabel
        }
        set {
            self.shadowStackView.accessibilityLabel = newValue
            self.configureAccessibility()
        }
    }
    ...
    override public var accessibilityHint: String? {
        get {
            return self.shadowStackView.accessibilityHint
        }
        set {
            self.shadowStackView.accessibilityHint = newValue
            self.configureAccessibility()
        }
    }
    ...
    public var pbBackgroundColor : UIColor?{
        set{
            self.bgView.backgroundColor = newValue
        }
        get{
            return self.pbBackgroundColor
        }
    }
    ...
    @objc dynamic public private(set) var shadowStackView: PBPopupBarTitlesView!
    ...
    @objc dynamic var progressView: PBPopupBarProgressView!
    ...
    public var bgViewLeading  : NSLayoutConstraint?
    public var bgViewTrailing : NSLayoutConstraint?
    ...
    internal override init(frame: CGRect) {
        ...
        self.safeAreaToolbar.isTranslucent = false
        ...
        bgViewLeading = bgView.leadingAnchor.constraint(equalTo: leadingAnchor)
        bgViewLeading?.isActive = true
        
        bgViewTrailing = bgView.trailingAnchor.constraint(equalTo: trailingAnchor)
        bgViewTrailing?.isActive = true
        ...
        self.shadowStackView = PBPopupBarTitlesView(frame: .zero)
        self.shadowStackView.isAccessibilityElement = true
        self.shadowStackView.accessibilityTraits = .button
        self.shadowStackView.accessibilityLabel = NSLocalizedString("Popup bar", comment: "")
        self.shadowStackView.autoresizingMask = []
        self.shadowStackView.isUserInteractionEnabled = false
        //shadowStackView.backgroundColor = .blue.withAlphaComponent(0.5)
        self.toolbar.addSubview(self.shadowStackView)
        ...
        self.shadowStackView.addArrangedSubview(self.titleLabel)
        ...
        self.shadowStackView.addArrangedSubview(self.subtitleLabel)
    ...
    override public func layoutSubviews() {
        ...
        shadowImageView.cornerRadius = shadowImageView.width / 2
    ...
    private func setupCustomPopupBarView() {
        ...
        self.shadowStackView.isHidden = hidden
    }
    ...
    private func layoutSafeAreaBackgroundView() {
        if PBPopupBarShowColors == true {
            ...
            self.safeAreaToolbar.barTintColor = UIColor.appTintColor
        }
    ...
    private func layoutBackgroundView() {
        if PBPopupBarShowColors == true {
            ...
            self.toolbar.barTintColor = UIColor.appTintColor
            self.toolbar.backgroundColor = .appTintColor
        }
    ...
    private func layoutTitlesView() {
        ...
        if left == 0.0 && right == 0.0 {
            if UIView.userInterfaceLayoutDirection(for: self.semanticContentAttribute) == .leftToRight {
                left = 16 + (hasImage ? (self.shadowImageView.frame.origin.x + self.shadowImageView.frame.size.width) : PBPopupBarImageHeightProminent + 16)
                right = 16
            }
            else {
        ...
        if PBPopupBarShowColors == true {
            self.shadowStackView.backgroundColor = UIColor.appTintColor
        }
        
        if self.shadowStackView.translatesAutoresizingMaskIntoConstraints == true {
            self.shadowStackView.translatesAutoresizingMaskIntoConstraints = false
            
            self.shadowStackView.topAnchor.constraint(equalTo: self.toolbar.topAnchor, constant: 8.0).isActive = true
            self.shadowStackView.bottomAnchor.constraint(equalTo: self.toolbar.bottomAnchor, constant: -8.0).isActive = true
        }
        ...
        if let leftConstraint = self.titlesViewLeftConstraint {
            ...
            self.titlesViewLeftConstraint = self.shadowStackView.leftAnchor.constraint(equalTo: self.toolbar.leftAnchor, constant: left)
        }
        ...
        if let rightConstraint = self.titlesViewRightConstraint {
            ...
            self.titlesViewRightConstraint = self.shadowStackView.rightAnchor.constraint(lessThanOrEqualTo: self.toolbar.rightAnchor, constant: -right)
            //self.shadowStackView.rightAnchor.constraint(equalTo: self.toolbar.rightAnchor, constant: -right)
        }
    ...
    private func configureAccessibility() {
        if let accessibilityLabel = self.accessibilityLabel, accessibilityLabel.count > 0 {
            self.shadowStackView.accessibilityLabel = accessibilityLabel
        }
        else {
            ...
            self.shadowStackView.accessibilityLabel = accessibility
        }
        
        if let accessibilityHint = self.accessibilityHint, accessibilityHint.count > 0 {
            self.shadowStackView.accessibilityHint = accessibilityHint
        }
        else {
            self.shadowStackView.accessibilityHint = NSLocalizedString("Double tap to open popup content", comment: "")
        }
    }
    ...
    private func configureTitleLabels() {
        if self.askForLabels {
            ...
            if let titleLabel = self.dataSource?.titleLabel?(for: self) {
                ...
                self.shadowStackView.removeArrangedSubview(self.titleLabel)
                self.titleLabel = titleLabel
                if PBPopupBarShowColors == true {
                    self.titleLabel.backgroundColor = UIColor.appTintColor
                }
                self.shadowStackView.insertArrangedSubview(self.titleLabel, at: 0)
            }
            ...
            if let subtitleLabel = self.dataSource?.subtitleLabel?(for: self) {
                ...
                self.shadowStackView.removeArrangedSubview(self.subtitleLabel)
                self.subtitleLabel = subtitleLabel
                if PBPopupBarShowColors == true {
                    self.subtitleLabel.backgroundColor = UIColor.appTintColor
                }
                self.shadowStackView.addArrangedSubview(self.subtitleLabel)
            }
        }
            ...
            if leftItems.count > 0 {
                ...
                if UIView.userInterfaceLayoutDirection(for: self.semanticContentAttribute) == .leftToRight {
                    if let leftItemView = (leftItems[leftItems.count - 1] as AnyObject).value(forKey: "view") as? UIView {
                        if PBPopupBarShowColors == true {
                            leftItemView.backgroundColor = UIColor.appTintColor
                        }
            ...
            if rightItems.count > 0 {
                ...
                if UIView.userInterfaceLayoutDirection(for: self.semanticContentAttribute) == .leftToRight {
                    if let rightItemView = (rightItems[0] as AnyObject).value(forKey: "view") as? UIView {
                        if PBPopupBarShowColors == true {
                            rightItemView.backgroundColor = UIColor.appTintColor
                        }
