    ...
    internal var barStyle: UIBarStyle! {
        didSet {
            if let popupContentView = self.containerViewController.popupContentView, let popupEffectView = popupContentView.popupEffectView, popupEffectView.effect != nil {
                ...
                if barStyle == .black {
                    popupContentView1.popupEffectView.effect = UIBlurEffect(style: .systemThickMaterialDark)
                }
                popupContentView1.popupEffectView.effect = UIBlurEffect(style: .systemThickMaterial)
                #else
